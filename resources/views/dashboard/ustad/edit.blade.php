...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  <h1 class="h2">Edit Data ustad</h1>
</div>

<div class="col-lg-8">
    <form action="/ustad/{{ $user->id }}" method="post">
      {{-- @method('put') --}}
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
          <label for="kelas" class="form-label">Jabatan</label>
        ...
        <button type="submit" class="btn btn-primary">Update Data ustad</button>
      </form>
